...
public class CompositeData
{
  ...
  /// Indicates if <see cref="SyncInCnt"/> has valid data.
  /// </summary>
  public bool HasSyncOutCnt { get { return _syncOutCnt.HasValue; } }

  /// <summary>
  /// SyncInCnt data.
  /// </summary>
  public UInt32 SyncOutCnt
  {
    get { return _syncOutCnt.Value; }
    set { _syncOutCnt = value; }
  }
  private UInt32? _syncOutCnt;

  /// <summary>
  /// Indicates if <see cref="SyncInCnt"/> has valid data.
  /// </summary>
  public bool HasTimeStatus { get { return _timeStatus.HasValue; } }
  ...
  {
    get { return _timeStatus.Value; }
    set { _timeStatus = value; }
  }
  private byte? _timeStatus;
  ...
  /// <summary>
  /// Indicates if <see cref="Dop"/> has valid data.
  /// </summary>
  public bool HasDop { get { return _dop.HasValue; } }

	/// <summary>
	/// GNSS dilution of precision data.
	/// </summary>
	public vecDop Dop
	{
		get { return _dop.Value; }
		set
		{
      _dop = value;
		}
  ...
  /// <summary>
  /// Indicates if <see cref="TimeInfo"/> has valid data.
  /// </summary>
  public bool HasTimeInfo { get { return _timeInfo.HasValue; } }

  /// <summary>
  /// GNSS dilution of precision data.
  /// </summary>
  public TimeInfo GnssTimeInfo {
    get { return _timeInfo.Value; }
    set {
      _timeInfo = value;
    }
  }
  ...
  public bool HasPositionUncertaintyEstimated { get { return _positionUncertaintyEstimated.HasValue; } }
    ...
    if ((gf & TimeGroup.SyncOutCnt) != 0)
      { var v = p.ExtractUint32(); foreach (var cd in o) { cd.SyncOutCnt = v; } }

    if ((gf & TimeGroup.TimeStatus) != 0)
      { var v = p.ExtractUint8(); foreach (var cd in o) { cd.TimeStatus = v; } }
    ...
    if((gf & GpsGroup.TimeInfo) != 0) 
      { var v = p.ExtractUint32(); foreach(var cd in o) { cd.TimeUncertainty = v; } }

    if((gf & GpsGroup.GpsDOP) != 0) 
      { var dop = p.ExtractDop(); foreach(var cd in o) { cd.Dop = dop; } }
    }
